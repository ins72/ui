...
import { Eye, EyeOff, ArrowRight, Mail, Lock, User, Building, Check } from "lucide-react";
...
const RegisterPage = () => {
    ...
    const plans = [
        { value: "free", label: "Free Plan", description: "30% revenue share" },
        { value: "pro", label: "Pro Plan", description: "$49/month fixed fee" },
        { value: "enterprise", label: "Enterprise Plan", description: "15% revenue share, min $99/month" }
    ];
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-start">
                                <input
                                    ...
                                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded mt-1"
                                />
                                <label htmlFor="marketingEmails" className="ml-2 block text-sm text-gray-900 dark:text-gray-300">
                                    I want to receive marketing emails about Mewayz products and services
                                </label>
                            </div>
                        </div>
            ...
            <div className="mt-8 text-center">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                    &copy; 2024 Mewayz. All rights reserved.
                </p>
            </div>
        </div>
    );

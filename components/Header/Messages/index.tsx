...
const messages = [
    {
        ...
        time: "2m ago",
        content: "Great work on the latest project! The design looks amazing.",
        new: true
    },
    {
        id: 2,
        ...
        time: "15m ago",
        content: "Can we schedule a meeting to discuss the upcoming features?",
        new: true
    },
    {
        id: 3,
        ...
        time: "1h ago",
        content: "Thanks for the quick response on the bug fix!",
        new: false
    }
];
